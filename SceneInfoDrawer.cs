    ...
    public class SceneInfoDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                Rect useVideoClipRect = position;
                useVideoClipRect.height = EditorGUIUtility.singleLineHeight;
                useVideoClipRect.y += SPACING * (4 + space);
                SerializedProperty m_useVideoClip = property.FindPropertyRelative("useVideoClip");
                EditorGUI.PropertyField(useVideoClipRect, m_useVideoClip);

                Rect videoClipRect = position;
                videoClipRect.height = EditorGUIUtility.singleLineHeight;
